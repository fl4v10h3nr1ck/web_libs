	...
	private $print_querys = false;
		...
		public function getPorQuery($item, $join, $where, $orderby, $limit=""){
		
		$erro = $this->prepara($item);
		if($erro<0)
		return $erro;
		
		return $this->get($item, $join, $where, $orderby, $limit);	
		}	
		...
		private function get($item, $join, $where, $orderby, $limit=""){
