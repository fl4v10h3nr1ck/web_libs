...
final class Dialogo{
	...
	<script src='".TAB_BASE_DIA_SPS."dialogo.js' type='text/javascript'></script>
	
	<link rel='stylesheet' href='".TAB_BASE_DIA_SPS."dialogo.css' type='text/css' media='all'>";
	}
	...
	$aux = "<div align='center' class='dialogo_div_geral largura_".$largura_porcento."' style='height:".$altura_px."px' id='".$id."'>
			<input type='hidden' value='".$largura_porcento."' id='largura'>	
				<table width='96%' style='background:#EEE;margin-top:5px'>
					<tr>
						...
						<button onclick='javascript:fechar()'><img src='".TAB_BASE_DIA_SPS."imgs/fechar.png' style='width:30px;height:30px'></button>
						</td>
					</tr>
				</table>
				<hr with='100%'>
				<div align='left' style='background:#FFF;margin:auto;height:".($altura_px-60)."px'>
