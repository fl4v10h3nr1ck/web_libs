	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var selectableYears = null;
				
				if(options.selectableYears==null)
					selectableYears = getSelectableList(todayVal.year - 5, todayVal.year + 5, options.selectableYears);
				else
					selectableYears = getSelectableList(options.selectableYears[0], options.selectableYears[options.selectableYears.length-1], options.selectableYears);
